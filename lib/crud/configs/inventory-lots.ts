...
export const inventoryLotConfig: EntityConfig = {
  ...
  permissions: {
    list: ['admin', 'oms_manager', 'tms_manager', 'wms_manager', 'wms_supervisor', 'wms_inbound_worker', 'wms_outbound_worker', 'employee', 'user'],
    create: [], // WMS 模块不允许手动创建
    update: ['admin', 'wms_manager', 'wms_supervisor', 'wms_inbound_worker', 'wms_outbound_worker'],
    delete: [], // WMS 模块不允许删除
  },
